...
function App() {
  ...
  return (
    <div className="min-h-screen md:h-screen w-screen flex items-center justify-center bg-[#111315] relative py-4">
      <div className="absolute top-0 left-0 w-full h-[20%]">
        <img className="w-full h-full object-cover" src={imageLink} alt="bg-image"/>
      </div>
      <div className="w-[80%] h-[90%] px-6 py-6 flex flex-col gap-3 z-10 bg-[#1B1D1F] rounded-md shadow-lg">
